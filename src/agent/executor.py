...
7. **输出语言** — 报告与 JSON 内所有文本（核心结论、摘要、展望、风险、操作建议等）必须使用 **韩语（한국어）** 撰写。例如 one_sentence、position_advice、analysis_summary、risk_warning 等字段值均须以韩语输出。
